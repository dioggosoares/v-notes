...
export function NoteCard({ note, onNoteDeleted }: NoteCardProps) {
  return (
    <Dialog.Root>
      ...
      overflow-hidden relative hover:ring-2 hover:ring-slate-600 focus-visible:ring-2
      focus-visible:ring-lime-400 transition-shadow duration-150 ease-linear outline-none"
      >
      ...
      <Dialog.Portal>
        ...
        >
          ...
          <button
            ...
            className="group w-full bg-slate-800 py-4 text-center text-sm
            text-slate-300 outline-none font-medium"
          >
            Deseja{' '}
